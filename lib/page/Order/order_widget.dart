    ...
    return new Row(
        ...
        children: <Widget>[
          ...
          new Padding(
              ...
              child: new Text(this._order.resourceSection.sourceName.toString(),
                  style: TextStyle(
          ...
          new Flexible(
              ...
              child: new Padding(
                  padding: EdgeInsets.symmetric(horizontal: 5),
                  child: new Text(this._order.resourceSection.source,
                      style: TextStyle(
                          color: Colors.blueGrey,
                          fontWeight: FontWeight.bold)))),
          new Flexible(
              flex: 1,
              child: new Text("${this._order.id.toStringAsFixed(2)}",
                  style: TextStyle(
                      color: Colors.blueGrey, fontWeight: FontWeight.bold))),
          FlatButton(
              onPressed: () {
