...
class _SearchClassState extends State<SearchClass> {
  ...
  Widget build(BuildContext context) {
    return Padding(
      padding: const EdgeInsets.only(top: 520.0, left: 18, right: 16),
      child: Column(
          ...
          if (!snapshot.hasData) {
            ...
            return GridView(
              ...
              children: List<Widget>.generate(
                ...
                (int index) {
                  final int count = this.searchTags.length;
                  ...
                  return CategoryView(
                    ...
                    category: this.searchTags[index],
                    animation: animation,
                    animationController: animationController,
                  );
                },
                          ...
                          Expanded(
                            child: Container(
                              decoration: BoxDecoration(
                                ...
                                border:
                                    new Border.all(color: Color(0xFFEDF0F2)),
                              ),
                              child: Column(
                                children: <Widget>[
                                  Expanded(
