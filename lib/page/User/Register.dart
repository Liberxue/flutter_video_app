...
import 'package:ciying/Utils/validation.dart';
...
class RegisterState extends State<Register>
  ...
  ///用户密码确认输入框TextField的控制器
  TextEditingController _userRepeatPasswrodtController;
  ...
  void initState() {
    ...
    //输入确认密码TextField控制器
    _userRepeatPasswrodtController = TextEditingController();
          ...
          children: [
            ...
            Container(
              margin: EdgeInsets.only(
                  left: 22, right: 22, top: 20.0 * logoAnimation.value),
            ),
            ...
            buildUserRowWidgets(
                ...
                "请再次输入6-12密码",
                true,
                userRepeatPasswordFieldNode,
                _userRepeatPasswrodtController,
                isPasswordError),
      ...
      children: [
        ...
        Expanded(
          child: TextField(
            ...
            ///设置键盘的类型
            keyboardType:
                isPasswordInput ? TextInputType.text : TextInputType.number,

            obscureText: isPasswordInput ? true : false,

            ///输入文本的样式
            style: TextStyle(fontSize: 14.0, color: Color(0xFF213333)),
